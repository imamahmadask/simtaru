                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <small class="form-text text-muted d-block mt-1">
                                    Format password wajib: Minimal 8 karakter, kombinasi huruf besar (A-Z), huruf kecil (a-z), angka (0-9), dan simbol (!@#$%^&*). Password tidak boleh sama dengan username/email.
                                </small>
                                @error('password')
