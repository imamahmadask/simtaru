<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Penilaian /</span> Tambah Penilaian</h4>        
        <div class="card">
            <div class="card-body">
                <form wire:submit.prevent="store" enctype="multipart/form-data">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="nomor_dokumen">Nomor Dokumen Pemanfaatan Ruang</label>
