<div>
    <div wire:ignore.self class="modal fade" id="AddKajianSkrkModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form wire:submit="createKajianAnalisa">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" wire:model="penguasaan_tanah"
                                    id="create_penguasaan_tanah" placeholder="Masukkan Informasi Penguasaan Tanah">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_ada_bangunan" class="form-label">Ada Bangunan</label>
                                <select name="ada_bangunan" wire:model="ada_bangunan" id="create_ada_bangunan"
                                    class="form-select">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_jml_bangunan" class="form-label">Jumlah Bangunan</label>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_jml_lantai" class="form-label">Rencana Jumlah Lantai Bangunan</label>
                                <input type="text" class="form-control" wire:model="jml_lantai" id="create_jml_lantai"
                                    placeholder="Masukkan Rencana Jumlah Lantai Bangunan">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_luas_lantai" class="form-label">Luas Lantai Bangunan</label>
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            const modal = bootstrap.Modal.getInstance(document.getElementById('AddKajianSkrkModal'));
            if (modal) {
                modal.hide();
            }
        });
