<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                                    ...
                                    @can('manageDataEntry', $skrk->permohonan)
                                        @if ($skrk->is_validate)
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#UploadDokumenFixModal">
                                                <i class="bx bx-cloud-upload"></i> Dokumen SKRK Fix
                                            </button>
                                        @endif
                                    @endcan
                                </div>
        ...
        <div wire:ignore.self class="modal fade" id="UploadDokumenFixModal" data-bs-backdrop="static" tabindex="-1"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form wire:submit="uploadDokumenFix">
                        <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col mb-3">
                                        ...
                                        <input type="file" class="form-control"
                                            wire:model="file_.{{ $item->kode }}" id="file_.{{ $item->id }}">
                                    </div>
                                </div>
                            @endforeach
                        </div>
