<div>
    <div wire:ignore.self class="modal fade" id="EditSurveyKkprbModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">
                        Edit Survey KKPR Berusaha
                    </h5>
                ...
                <form wire:submit="EditSurvey">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="edit-tgl_survey" class="form-label">Tanggal Survey</label>
                                <input type="date" class="form-control" wire:model="tgl_survey" id="edit-tgl_survey">
                                @error('tgl_survey')
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <select class="form-select" wire:model="ada_bangunan" id="edit_ada_bangunan">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" wire:model="pola_ruang" id="edit_pola_ruang">
                                @error('pola_ruang')
                                    <span class="form-text text-xs text-danger"> {{ $message }} </span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="edit_gambar_peta" class="form-label">
                                ...
                                <input type="file" class="form-control" wire:model.blur="gambar_peta"
                                    id="edit_gambar_peta" multiple accept="image/*">
                                <div class="form-text">Hanya format gambar yang diizinkan. Maks 1MB/file.</div>
                                @error('gambar_peta.*')
                                    <span class="form-text text-xs text-danger"> {{ $message }} </span>
                                @enderror
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            const modal = bootstrap.Modal.getInstance(document.getElementById('EditSurveyKkprbModal'));
            if (modal) {
                modal.hide();
            }
        });
