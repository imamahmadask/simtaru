<div>
    <div wire:ignore.self class="modal fade" id="editDataFinalKkprbModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            const modal = bootstrap.Modal.getInstance(document.getElementById('editDataFinalKkprbModal'));
            if (modal) {
                modal.hide();
            }
        });
