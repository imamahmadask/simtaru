    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Permohonan /</span> Detail Permohonan KKPR Berusaha Non UMK
            </h4>
        </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navs-pills-top-general" role="tabpanel">
                            <div class="row">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nama"
                                                        value="{{ $kkprb->permohonan->registrasi->nama }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nik"
                                                        value="{{ Str::mask($kkprb->permohonan->registrasi->nik, '*', 5, -1) }}"
                                                        readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="no_hp"
                                                        value="{{ $kkprb->permohonan->registrasi->no_hp }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="email"
                                                        value="{{ $kkprb->permohonan->registrasi->email }}"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="npwp"
                                                        value="{{ $kkprb->permohonan->npwp }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="alamat_pemohon"
                                                        value="{{ $kkprb->permohonan->alamat_pemohon }}" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body mt-3">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="kode"
                                                        value="{{ $kkprb->permohonan->registrasi->kode }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="layanan" class="form-control"
                                                        value="{{ $kkprb->permohonan->layanan->nama }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="tanggal"
                                                        value="{{ date('d-m-Y', strtotime($kkprb->permohonan->created_at)) }}"
                                                        readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="alamat_tanah" class="form-control"
                                                        value="{{ $kkprb->permohonan->registrasi->alamat_tanah }}"
                                                        readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="kel_tanah" class="form-control"
                                                        value="{{ $kkprb->permohonan->registrasi->kel_tanah }}"
                                                        readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="kec_tanah" class="form-control"
                                                        value="{{ $kkprb->permohonan->registrasi->kec_tanah }}"
                                                        readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="fungsi_bangunan" class="form-control"
                                                        value="{{ $kkprb->permohonan->registrasi->fungsi_bangunan }}"
                                                        readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="luas_tanah" class="form-control"
                                                        value="{{ $kkprb->permohonan->luas_tanah }} m2" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="status_modal" class="form-control"
                                                        value="{{ $kkprb->permohonan->status_modal }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="kbli" class="form-control"
                                                        value="{{ $kkprb->permohonan->kbli }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="judul_kbli" class="form-control"
                                                        value="{{ $kkprb->permohonan->judul_kbli }}" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="tgl_validasi" class="form-control"
                                                        value="@if($kkprb->tgl_validasi != null) {{ date('d-m-Y', strtotime($kkprb->tgl_validasi)) }} @endif" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-4 col-form-label" for="tgl_terima_ptp">
                                                    Tanggal Pembayaran PNBP
                                                </label>
                                                <div class="col-sm-8">
                                                    <input type="text" id="tgl_terima_ptp" class="form-control"
                                                        value="@if($kkprb->tgl_pnbp != null) {{ date('d-m-Y', strtotime($kkprb->tgl_pnbp)) }} @endif" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="tgl_ptp" class="form-control"
                                                        value="@if($kkprb->tgl_ptp != null) {{ date('d-m-Y', strtotime($kkprb->tgl_ptp)) }} @endif" readonly />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="status" class="form-control"
                                                        value="{{ $kkprb->permohonan->status }}" readonly />
                                                </div>
                                            </div>
                                            @if ($kkprb->permohonan->status == 'success')
                                                <div class="row mb-3">
                                                    <label class="col-sm-4 col-form-label" for="status">Tanggal
                                                        Selesai</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="status" class="form-control"
                                                            value="{{ date('d-m-Y', strtotime($kkprb->permohonan->tgl_selesai)) }}"
                                                            readonly />
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm d-flex justify-content-around flex-wrap">
                                                    <a href="{{ $kkprb->permohonan->berkas_ktp ? asset('storage/' . $kkprb->permohonan->berkas_ktp) : 'javascript:void(0)' }}"
                                                        target="_blank" type="button" class="btn btn-primary m-1"
                                                        id="berkas">
                                                        KTP
                                                    </a>
                                                    <a href="{{ $kkprb->permohonan->berkas_permohonan ? asset('storage/' . $kkprb->permohonan->berkas_permohonan) : 'javascript:void(0)' }}"
                                                        target="_blank" type="button" class="btn btn-primary m-1">
                                                        Permohonan
                                                    </a>

                                                    <a href="{{ $kkprb->permohonan->berkas_kuasa ? asset('storage/' . $kkprb->permohonan->berkas_kuasa) : 'javascript:void(0)' }}"
                                                        target="_blank" type="button" class="btn btn-primary m-1">
                                                        Surat Kuasa
                                                    </a>

                                                    <a href="{{ $kkprb->permohonan->berkas_nib ? asset('storage/' . $kkprb->permohonan->berkas_nib) : 'javascript:void(0)' }}"
                                                        target="_blank" type="button" class="btn btn-primary m-1">
                                                        NIB
                                                    </a>

                                                    <a href="{{ $kkprb->permohonan->berkas_penguasaan ? asset('storage/' . $kkprb->permohonan->berkas_penguasaan) : 'javascript:void(0)' }}"
                                                        target="_blank" type="button" class="btn btn-primary m-1">
                                                        Penguasaan
                                                    </a>
                                                    <a href="{{ $kkprb->berkas_ptp ? asset('storage/' . $kkprb->berkas_ptp) : 'javascript:void(0)' }}"
                                                        target="_blank" type="button" class="btn btn-primary m-1">
                                                        PTP
                                                    </a>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea id="keterangan" class="form-control" aria-describedby="basic-icon-default-message2" readonly>{{ $kkprb->permohonan->keterangan }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6">
                                    @livewire('admin.permohonan.riwayat.riwayat-permohonan-index', ['permohonan' => $kkprb->permohonan])
                                </div>
                            </div>
                        </div>

                        <div class="tab-pane fade" id="navs-pills-top-survey" role="tabpanel">
                            @livewire('admin.permohonan.kkprb.survey.kkprb-survey-detail', ['kkprb_id' => $kkprb->id])
                        </div>

                        <div class="tab-pane fade" id="navs-pills-top-analisa" role="tabpanel">
                            @livewire('admin.permohonan.kkprb.analis.kkprb-analis-detail', ['kkprb_id' => $kkprb->id])
                        </div>

                        <div class="tab-pane fade" id="navs-pills-top-jafung" role="tabpanel">
                            @livewire('admin.permohonan.kkprb.spv.kkprb-verifikasi-detail', ['kkprb_id' => $kkprb->id])
                        </div>

                        <div class="tab-pane fade" id="navs-pills-top-finalisasi" role="tabpanel">
                            @livewire('admin.permohonan.kkprb.final.kkprb-final-detail', ['kkprb_id' => $kkprb->id])
                        </div>
                    </div>
                </div>
            </div>
