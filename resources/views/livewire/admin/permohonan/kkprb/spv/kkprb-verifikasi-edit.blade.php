            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="updateVerifikasi">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" id="auto-close-btn">Batal</button>
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            const modal = bootstrap.Modal.getInstance(document.getElementById('EditVerifikasiModal'));
            if (modal) {
                modal.hide();
            }
        });
