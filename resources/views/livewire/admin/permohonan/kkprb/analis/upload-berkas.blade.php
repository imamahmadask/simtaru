<div>
    <div wire:ignore.self class="modal fade" id="UploadBerkasAnalisaKkprbModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">
                        Upload Berkas Analisa KKPR Berusaha Non UMK
                    </h5>
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            const modal = bootstrap.Modal.getInstance(document.getElementById('UploadBerkasAnalisaKkprbModal'));
            if (modal) {
                modal.hide();
            }
        });
