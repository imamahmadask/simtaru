            ...
            <div class="modal-content">
                ...
                <form wire:submit="createKajianAnalisa">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_tgl_oss" class="form-label">Tanggal OSS</label>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="number" class="form-control" wire:model="luas_disetujui" id="create_luas_disetujui"
                                    placeholder="Masukkan Luas Disetujui">
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_no_nota_dinas" class="form-label">No Nota Dinas</label>
                                <input type="text" class="form-control" wire:model="no_nota_dinas" id="create_no_nota_dinas"
                                    placeholder="Masukkan No Nota Dinas">
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_tgl_nota_dinas" class="form-label">Tanggal Nota Dinas</label>
                                <input type="date" class="form-control" wire:model="tgl_nota_dinas" id="create_tgl_nota_dinas"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="number" class="form-control" wire:model="nib" id="create_nib"
