<div>
    <div wire:ignore.self class="modal fade" id="EditSurveyItrModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <textarea class="form-control" wire:model="pola_ruang" id="edit_pola_ruang" rows="5"></textarea>
                                @error('pola_ruang')
                                    <span class="form-text text-xs text-danger"> {{ $message }} </span>
                                @enderror
                            </div>
