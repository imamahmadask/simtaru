<div>
    <div wire:ignore.self class="modal fade" id="editDataFinalItrModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">
                        Upload Dokumen ITR Fix
                    </h5>
                ...
                <form wire:submit="editFinal">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="no_dokumen" class="form-label">Nomor Dokumen ITR</label>
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            const modal = bootstrap.Modal.getInstance(document.getElementById('editDataFinalItrModal'));
            if (modal) {
                modal.hide();
            }
        });
