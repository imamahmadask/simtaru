            ...
            <div class="modal-content">
                ...
                <form wire:submit="createKajianAnalisa">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_jenis_kegiatan" class="form-label">Jenis Kegiatan</label>
                                <input type="text" class="form-control" wire:model="jenis_kegiatan" id="create_jenis_kegiatan"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="create_ketinggian_bangunan_max" class="form-label">Ketinggian Bangunan Maksimum</label>
                                <input type="text" class="form-control" wire:model="ketinggian_bangunan_max" id="create_ketinggian_bangunan_max"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <textarea class="form-control" wire:model="persyaratan_pelaksanaan" id="create_persyaratan_pelaksanaan" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            const modal = bootstrap.Modal.getInstance(document.getElementById('AddKajianKkprnbModal'));
            if (modal) {
                modal.hide();
            }
        });
