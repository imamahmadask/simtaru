            ...
            <div class="modal-content">
                ...
                <form wire:submit="updateKajianAnalisa">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="edit_ada_bangunan" class="form-label">Sudah Ada Bangunan</label>
                                <select name="ada_bangunan" id="edit_ada_bangunan" wire:model="ada_bangunan" class="form-control">
