<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Permohonan /</span> KKPR Non Berusaha</h4>

        <!-- Basic Bootstrap Table -->
        <div class="card">
            <h5 class="card-header">List Permohonan KKPR Non Berusaha</h5>
                        ...
                        @foreach ($kkprnb as $data)
                            <div wire:key="{{ $data->id }}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('kkprnb.detail', ['id' => $data->id]) }}" type="button"
