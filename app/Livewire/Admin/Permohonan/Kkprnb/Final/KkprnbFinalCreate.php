...
class KkprnbFinalCreate extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.admin.permohonan.kkprnb.final.kkprnb-final-create');
    }    
    ...
    {
        $no_reg = $this->kkprnb->permohonan->registrasi->kode;
