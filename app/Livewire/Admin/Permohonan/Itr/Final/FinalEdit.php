...
class FinalEdit extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.admin.permohonan.itr.final.final-edit');
    }
    ...
    public function editFinal()
    {
        ...
        $this->createRiwayat($this->itr->permohonan, 'Edit Dokumen ITR selesai!');

        session()->flash('success', 'Dokumen ITR Fix berhasil diupdate!');
